...
(function (SBA) {
  ...
  var STRINGS = {
    ...
    /* --- Sold-by-weight selector --- */
    "weight.perKg":             { fr: "/ kg",                 ar: "/ كغ" },
    "weight.customPlaceholder": { fr: "Autre (g)",             ar: "آخر (غ)" },
    "weight.addBtn":            { fr: "Ajouter au panier",     ar: "أضف إلى السلة" },
    "weight.minError":          { fr: "Minimum 50 g",          ar: "الحد الأدنى 50 غ" },
    "weight.cartWeightLabel":   { fr: "{w} g",                 ar: "{w} غ" },
    "weight.cartUnitLine":      { fr: "{w} g · {price} / kg",  ar: "{w} غ · {price} / كغ" }
  };
